      ...
      <div className='w-full max-w-md bg-white p-6 sm:p-10 border border-slate-100 rounded-2xl shadow-xl shadow-indigo-900/5' >
        <div className='text-center mb-8'>
          ...
          <h1 className='text-3xl sm:text-4xl font-black text-slate-900 leading-tight'>
            Get <span className='bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-violet-500'>Started</span>
          </h1>
          <p className='text-slate-500 mt-3 text-sm sm:text-base px-2'>
            Join thousands of developers practicing with I-Interviewer
          </p>
        </div>
        ...
        <form onSubmit={onSubmit} className='grid grid-cols-1 gap-4'>
          <div className='space-y-1.5'>
            ...
            <input type="text" name="name" value={name} className='w-full p-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all' placeholder='Rushan Dayma' onChange={onChange} required />
          </div>
          <div className='space-y-1.5'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
            ...
            <div className='space-y-1.5'>
              <label className='text-[10px] font-bold uppercase text-slate-400 ml-1'>Confirm</label>
              <input type="password" name="password2" value={password2} className='w-full p-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition-all' placeholder='********' onChange={onChange} required />
            </div>
          </div>
